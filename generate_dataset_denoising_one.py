...
while True:
    ...
    # adding to dataset
    X = np.load("dataset_denoising_one_X.npz")['arr_0']
    y = np.load("dataset_denoising_one_y.npz")['arr_0']
    ...
    np.savez_compressed("dataset_denoising_one_X", X)
    np.savez_compressed("dataset_denoising_one_y", y)
